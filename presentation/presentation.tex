...
\item Only one way to insert $2m$. Then three ways to insert $2m-2$. Then five ways to insert $2m-4$. Repeat, until there are $2m-1$ ways to insert $2$.
\end{enumerate}
\end{proof}
\end{frame}
...
\begin{frame}
\begin{lemma}
Let $\sigma\in T_n$, and let $a, b\in \{1, 2, \ldots, n\}$ with $a$ to the left of $b$. If $a>b$, then $b$ is even.
\end{lemma}
\begin{proof}
